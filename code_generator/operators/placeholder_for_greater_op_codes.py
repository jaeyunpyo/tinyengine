# code_generator/operators/placeholder_for_greater_op_codes.py

import warnings
from .basic_utils import basicOperator, deep_copy_dicts, overwrite_dicts

__all__ = ["PlaceholderForGreaterOpCodesOperator"]

default_params = {
    # Operator related
    "op": "PLACEHOLDER_FOR_GREATER_OP_CODES",
    # Tensor related
    "input_idx": None,
    "output_idx": None,
    "input_shape": None,
...
class PlaceholderForGreaterOpCodesOperator(basicOperator):
    ...
    def generate_inference_str(self):
        ...
        string = (
            f"placeholder_for_greater_op_codes({input_str}, {output_str}, "
