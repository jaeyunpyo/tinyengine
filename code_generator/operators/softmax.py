# code_generator/operators/softmax.py

import warnings
from .basic_utils import basicOperator, deep_copy_dicts, overwrite_dicts

__all__ = ["SoftmaxOperator"]
...
default_params = {
    ...
    "beta": 1.0,  # Softmax temperature parameter
}

class SoftmaxOperator(basicOperator):
    ...
    def generate_inference_str(self):
        ...
        string = (
            f"softmax({input_str}, {output_str}, {self.params['input_shape'][0]}, "
            f"{self.params['input_shape'][1]}, {self.params['beta']});\n"
        )
