# code_generator/converters/tflite_parser/batch_matmul.py

from code_generator.operators.batch_matmul import BatchMatMulOperator
from .utils import get_input_tensors, get_output_tensors, getTensorTypeStr

def parse_batch_matmul(op, model):
    ...
    return BatchMatMulOperator(params)
